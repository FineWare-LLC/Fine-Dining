...
import EmailIconModule from '@mui/icons-material/Email';
import {
    Box,
    Card,
    CardContent,
...
const EmailIcon = resolveMuiIcon(EmailIconModule);
        ...
        <>
            ...
            <AuthShell>
                ...
                >
                    ...
                    <Box
                        sx={{
                            background: theme.palette.gradient?.primary || 'linear-gradient(135deg, #C65D2B 0%, #E7B14B 100%)',
                            p: 3,
                            position: 'relative',
                        }}
                    >
