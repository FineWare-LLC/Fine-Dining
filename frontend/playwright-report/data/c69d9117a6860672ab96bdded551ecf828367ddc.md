...
- Name: Create Account Page - Comprehensive Tests >> should show errors if other fields are missing
- Location: /Users/tt/IdeaProjects/Fine-Dining/frontend/src/tests/components/create-account.spec.js:66:5
