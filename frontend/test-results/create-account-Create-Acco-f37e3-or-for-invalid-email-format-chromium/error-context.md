...
- Name: Create Account Page - Comprehensive Tests >> should show error for invalid email format
- Location: /Users/tt/IdeaProjects/Fine-Dining/frontend/src/tests/components/create-account.spec.js:74:5
