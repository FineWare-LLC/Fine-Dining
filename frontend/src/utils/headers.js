 ...
 * Generates the ID by concatenating the current timestamp and a random
 * alphanumeric segment. This approach works in both Node.js and the Edge
 * runtime without relying on crypto.randomUUID().
 * @param {import('http').ServerResponse | import('next/server').NextResponse} res
 * @returns {string}
 */
