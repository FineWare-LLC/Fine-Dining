...
- Name: Create Account Page - Comprehensive Tests >> should show errors if all fields are empty
- Location: /Users/tt/IdeaProjects/Fine-Dining/frontend/src/tests/components/create-account.spec.js:58:5
