        ...
        <AuthShell>
            <Card
                sx={{
                    ...
                    background: `linear-gradient(135deg, ${alpha(theme.palette.background.paper, 0.94)} 0%, ${alpha(theme.palette.background.paper, 0.98)} 100%)`,
                ...
                <CardContent sx={{ p: { xs: 3, sm: 4 } }}>
                    <Box sx={{ mb: 3 }}>
                        ...
                        <Typography variant="body2" color="text.secondary">
                            Build meal plans, track nutrition, and discover new favorites.
                        </Typography>
                    </Box>
