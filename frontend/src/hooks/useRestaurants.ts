...
import {
    buildRestaurantFeedbackContainerStyles,
    buildRestaurantFeedbackState,
...
export const useRestaurants = (options = {}) => {
    ...
    const feedback = buildRestaurantFeedbackState({
        isLoading,
        restaurantStatus,
    ...
    const feedbackSurfaceStyles = buildRestaurantFeedbackContainerStyles(feedback.state);
    ...
    // Data
        ...
        hasError: !!restaurantsError || restaurantStatus === 'error',
        isEmpty: !isLoading && !restaurantsError && filteredRestaurants.length === 0 && restaurantStatus !== 'error',
    };
};
