...
const buildCookbookFixture = () => {
    ...
    cookbook.save = async () => {
        ...
        throw new Error('database unavailable while saving imported recipe');
    };
...
test('addRecipeToCookbook rolls back a failed import and surfaces a recoverable error', async () => {
